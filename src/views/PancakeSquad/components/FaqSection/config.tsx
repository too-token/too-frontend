...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the TOO Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 TOO Tree NFTs at the snapshot may also purchase one additional TOO Squad NFT in the presale for each TOO Tree they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of TOO spent on TOO Squad NFTs will be burned as part of our weekly TOO burn.')],
  },
  {
