...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and TOO pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and TOO pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from TOO pool', data)
  }
